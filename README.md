...
Link to this page: http://bit.ly/binford-numbers2
...
* `library(usethis)`
* `use_course("https://github.com/jeremymcwilliams/intro-to-R-2020-2/archive/0.3.zip")`
...
* Enter the url: https://github.com/jeremymcwilliams/intro-to-r-2020-2
